...
christopher_robin = media.Movie("Christopher Robin",
                                "The little boy from the Winnie-the-Pooh stories, is now all grown up and has lost "
...
bohemian_rhapsody = media.Movie("Bohemian Rhapsody",
                                "Bohemian Rhapsody is an upcoming biographical musical film about the British rock "
                                "band Queen",
...
red_sparrow = media.Movie("Red Sparrow",
                          "Ballerina Dominika Egorova is recruited to 'Sparrow School,' a Russian intelligence "
                          "service where she is forced to use her body as a weapon.",
...
the_darkest_minds = media.Movie("The darkest minds",
                                "After a plague kills nearly all of America's children, the ones left are given "
                                "special abilities.",
                                "https://upload.wikimedia.org/wikipedia/en/7/7f/The_Darkest_Minds_teaser_poster.jpg",
